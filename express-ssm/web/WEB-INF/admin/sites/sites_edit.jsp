    ...
    <div class="panel form-element-padding">
        ...
        <div class="panel-body" style="padding-bottom:30px;">
            <form class="form-horizontal" method="post" id="commentForm" enctype="multipart/form-data"
                  action="${ctx}/sites/admin/edit">
                <input type="hidden" name="id" value="${sites.id}">
                <div class="form-group">
                    <label class="col-sm-3 control-label">站点编号：</label>
                    <div class="col-sm-8">
                        <input type='text' class='form-control' name='region' value='${sites.region}'>
                        <div class='tip1'></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type='text' class='form-control' name='siteName' value='${sites.siteName}'>
                        <div class='tip1'></div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">承载量/件：</label>
                    <div class="col-sm-8">
                        <input type='text' class='form-control' name='capacity' value='${sites.capacity}'>
                        <div class='tip1'></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-8">
                        <button class="btn btn-sm btn-info" onclick="update('sites')">提 交</button>
                    </div>
                </div>
            </form>
        </div>
