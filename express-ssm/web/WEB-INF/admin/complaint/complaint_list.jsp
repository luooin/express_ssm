...
<div class="form-element">
    <div class="panel form-element-padding">
        ...
        <div class="panel-body" style="padding-bottom:30px;">
            <form method="post" action="${ctx}/complaint/admin/query" id="ajaxForm">
                <table class="table table-bordered table-hover dataTables">
                    ...
                    <tbody>
                    <c:forEach varStatus="status" var="complaint" items="${complaintList}">
                        <tr>
                            <td>${status.index+1}</td>
                            <td>${complaint.userId}</td>
                            <td>${complaint.content}</td>
                            <td>
                                <a class="btn btn-info" href="${ctx}/complaint/admin/page/edit/${complaint.id}">编辑</a>
                                <a class="btn btn-danger" href="javascript:;"
                                   onclick="delObj(${complaint.id},'complaint')">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
