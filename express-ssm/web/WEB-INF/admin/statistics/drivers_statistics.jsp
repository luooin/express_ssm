            ...
            <div class="row">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        ...
                        司机：<select name="driver" id="driverId" class="form-control">
                                <option>请选择</option>
                        ...
                        <button class="btn btn-danger" type="button" onclick="search();">提 交</button>
                    </div>
                    <div class="ibox-content">
...
<script>
   ...
   function search(){
       ...
       var url =  $('#ctx').val() +"/drivers/admin/statistics?driverId=" + did + "&startDate=" + stime + "&endDate=" + etime;
       $.ajax({
           type: "POST",
           async: false,
           url: url,
