...
<div class="form-element">
    <div class="panel form-element-padding">
        ...
        <div class="panel-body" style="padding-bottom:30px;">
            <form method="post" action="${ctx}/admin/admin/query" id="ajaxForm">
                <table class="table table-bordered table-hover dataTables">
                    ...
                    <tbody>
                    <c:forEach varStatus="status" var="admin" items="${adminList}">
                        <tr>
                            <td>${status.index+1}</td>
                            <td>${admin.loginname}</td>
                            <td>${admin.password}</td>
                            <td>
                                <a class="btn btn-info" href="${ctx}/admin/admin/page/edit/${admin.id}">编辑</a>
                                <a class="btn btn-danger" href="javascript:;"
                                   onclick="delObj(${admin.id},'admin')">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
